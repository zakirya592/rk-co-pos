...
const JournalPaymentVouchersList = ({ onAddNew, onView, onEdit }) => {
  ...
  const handleDelete = async (voucher) => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        toast.success('Journal Payment Voucher deleted successfully');
  ...
  const handleView = async (voucher) => {
    try {
      ...
      const response = await userRequest.get(`/journal-payment-vouchers/${voucher._id}`);
  ...
  const generatePrintContent = (voucher) => {
    ...
    return `
      ...
      <html>
        <head>
          <title>Journal Payment Voucher - ${voucher.voucherNumber || voucher.referCode}</title>
          <style>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Journal-style entries with a currency and exchange rate on each line
            </p>
          </div>
          <Button
            color="primary"
        ...
        <ModalContent>
          <ModalHeader className="flex flex-col gap-1">
            <div className="flex items-center gap-3">
              <FaCoins className="text-amber-600" />
              <div>
                <h2>Journal Payment Voucher Details</h2>
              ...
              <div className="space-y-6">
                ...
                {hasJournalEntries(selectedVoucher) ? (
                  <div>
                    ...
                    <Table aria-label="Journal entries" removeWrapper>
                      <TableHeader>
