...
const CashPaymentVouchersList = ({ onAddNew, onView, onEdit }) => {
  ...
  const fetchVouchers = async () => {
    const response = await userRequest.get('/cash-payment-vouchers');
  ...
  const handleDelete = async (voucher) => {
    ...
    if (result.isConfirmed) {
      try {
        await userRequest.delete(`/cash-payment-vouchers/${voucher._id}`);
  ...
  const fetchVoucherDetails = async (voucherId) => {
    try {
      ...
      const response = await userRequest.get(`/cash-payment-vouchers/${voucherId}`);
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
          ...
          <div className="xl:col-span-3">
            ...
            <div className="overflow-x-auto">
              <Table
                aria-label="Cash Payment Vouchers table"
                selectionMode="none"
                classNames={{
                  wrapper: 'min-h-[500px]',
                }}
            ...
            {filteredVouchers.length === 0 && vouchers.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-gray-500 mb-4">
                  Get started by creating your first cash payment voucher
                </p>
                <Button
                  color="primary"
                  startContent={<FaPlus />}
                            ...
                            <div className="flex items-start gap-4">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <a
                                  ...
                                  className="text-xs text-green-600 hover:text-blue-800 font-medium inline-flex items-center gap-1"
                                >
                                  View Full Size →
                                </a>
                              </div>
...
export default CashPaymentVouchersList;
