...
const UpdateCashPaymentVoucher = ({ voucherId, onBack }) => {
    ...
    const fetchVoucher = async () => {
      try {
        ...
        setFormData({
          ...
          cashAccount: voucher.cashAccount?._id || voucher.cashAccount || '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(
        error.response?.data?.message || 'Failed to update cash payment voucher'
      );
    } finally {
                ...
                <CardBody className="p-6">
                  ...
                  <div className="space-y-2">
                    <div className="p-3 bg-green-50 rounded-lg">
                      <p className="font-semibold text-gray-900">
                        {typeof voucherInfo.cashAccount === 'object'
                          ? voucherInfo.cashAccount.name || voucherInfo.cashAccount.accountName
                          : voucherInfo.cashAccount}
                      </p>
                      {typeof voucherInfo.cashAccount === 'object' && voucherInfo.cashAccount.code && (
                        <p className="text-sm text-gray-600">
                          Code: {voucherInfo.cashAccount.code}
                        </p>
                      )}
                    </div>
                  </div>
