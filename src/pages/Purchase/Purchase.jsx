...
import SuppliersSelectionmodel from "./SuppliersSelectionmodel";
import SuppliersPaymentmodel from "./SuppliersPaymentmodel";
...
const Purchase = () => {
  ...
  const handlePayment = () => {
    setShowSuppliersPaymentmodel(true);
  };
  ...
  return (
    <div className="p-4 h-screen overflow-hidden">
      ...
      {/* Payment Modal */}
      <SuppliersPaymentmodel
        isOpen={showSuppliersPaymentmodel}
        onClose={() => setShowSuppliersPaymentmodel(false)}
        total={total}
